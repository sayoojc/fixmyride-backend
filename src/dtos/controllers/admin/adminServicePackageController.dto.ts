...
const PriceBreakupSchema = z.object({
  ...
  total: z.number().max(999999, "Total too high"),
});
...
export type UpdateServicePackageRequestDTO = z.infer<
  typeof UpdateServicePackageRequestSchema
>;
export type UpdateServicePackageResponseDTO = z.infer<
  typeof UpdateServicePackageResponseSchema
>;
export type AddServicePackageRequestDTO = z.infer<typeof ServicePackageSchema>;
export type ErrorResponse = z.infer<typeof ErrorResponse>;
export type AddServicePackageResponseDTO = z.infer<
  typeof AddServicePackageResponseSchema
>;
export type GetServicePackagesResponseDTO = z.infer<
  typeof getServicePackagesResponseSchema
>;
export type ToggleBlockStatusRequestDTO = z.infer<
  typeof ToggleBlockStatusRequestSchema
>;
export type ToggleBlockStatusResponseDTO = z.infer<
  typeof ToggleBlockStatusResponseSchema
>;
